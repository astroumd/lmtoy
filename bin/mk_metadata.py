...
if __name__ == "__main__":
    ...
    obsinfo["opacity225"]     = float(header(rc,"opacity225",debug)))
    ...
    lmt._add_metadata("referenceID", (rc,"referenceId",debug))

    # isCombined - bool, True if more than one obsnum/combined data
    lmt._add_metadata("isCombined", False)
